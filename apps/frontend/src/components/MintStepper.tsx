  ...
  const steps = [
    {
      ...
      title: "Metadata",
      icon: FileText,
      description: "Add artwork details",
    },
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setMetadata({ ...metadata, royalty: e.target.value })
                }
                min="0"
                max="50"
                className="input w-full"
                  ...
                  {fileData.preview ? (
                    <div className="space-y-4">
                      ...
                      <p className="text-sm text-secondary-600">
                        {fileData.file?.name} (
                        {((fileData.file?.size || 0) / 1024 / 1024).toFixed(2)}{" "}
                        MB)
                      </p>
                      <button
                        type="button"
              ...
              <div className="space-y-4">
                ...
                <div className="border-t pt-4">
                  <div className="flex justify-between font-semibold">
                    <span>Total</span>
                    <span>
                      {(parseFloat(metadata.price || "0") + 0.01).toFixed(3)}{" "}
                      ETH
                    </span>
                  </div>
                </div>
